...
# 連動鏈結
# https://notify-bot.line.me/oauth/authorize?response_type=code&client_id=REDACTED_LINE_NOTIFY_CLIENT_ID&redirect_uri=https://0adee5a7e592.ngrok.io/linebotnotify/getAuthorize&scope=notify&state=NO_STATE

ClientID = "REDACTED_LINE_NOTIFY_CLIENT_ID"
ClientSecret = "REDACTED_LINE_NOTIFY_CLIENT_SECRET"
...
def getLink():
    ...
    returnUrl = Url + 'response_type=code&client_id=REDACTED_LINE_NOTIFY_CLIENT_ID&redirect_uri=' + \
