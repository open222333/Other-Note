# Python 模組 PyTorch(機器學習)

```
PyTorch是一個開源的Python機器學習庫，基於Torch，底層由C++實現，應用於人工智慧領域，如電腦視覺和自然語言處理。

它主要由Meta Platforms的人工智慧研究團隊開發。
...
[PyTorch - Github](https://github.com/pytorch/examples/tree/main/mnist)
