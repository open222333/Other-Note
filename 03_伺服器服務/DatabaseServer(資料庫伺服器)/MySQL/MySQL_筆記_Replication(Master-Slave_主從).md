...
- [指令](#指令)
  ...
  - [基本用法（適用 MySQL 5.7 / 8.0）](#基本用法適用-mysql-57--80)
  - [MySQL 8.4 版本設置步驟](#mysql-84-版本設置步驟)
  - [keepalived (實作高可用)](#keepalived-實作高可用)
- [例外狀況](#例外狀況)
  - [重置 Replica 的 relay log（不會清 Source 資料）](#重置-replica-的-relay-log不會清-source-資料)
  - [修復 source replica 最快速方法](#修復-source-replica-最快速方法)
