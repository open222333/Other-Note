...
- [指令](#指令)
  ...
  - [SQL 指令](#sql-指令)
    - [連線](#連線)
      - [檢測帳號密碼是否可連線](#檢測帳號密碼是否可連線)
    - [帳號權限](#帳號權限)
    - [建立只讀帳號](#建立只讀帳號)
    - [查詢資料庫資訊](#查詢資料庫資訊)
    - [資料庫操作](#資料庫操作)
      - [刪除所有資料庫（保留系統 DB）](#刪除所有資料庫保留系統-db)
      - [列出所有資料表（db.table 格式）](#列出所有資料表dbtable-格式)
    - [資料表操作](#資料表操作)
    - [鎖定](#鎖定)
    - [使用者相關](#使用者相關)
    - [密碼設定強度修改](#密碼設定強度修改)
  ...
  - [匯出匯入](#匯出匯入)
    ...
    - [MySQL 5.7 → 8.4 備份與還原流程](#mysql-57--84-備份與還原流程)
      ...
      - [5. 建立 Master-Slave 同步](#5-建立-master-slave-同步)
        - [建議流程](#建議流程)
        - [Master 建立複製帳號](#master-建立複製帳號)
        - [Slave 建立連線](#slave-建立連線)
        - [確認同步狀態](#確認同步狀態)
      - [附錄：語法對照表（5.7 → 8.4）](#附錄語法對照表57--84)
      - [附錄：直接匯入（無需修正時）](#附錄直接匯入無需修正時)
    - [匯出資料到 CSV](#匯出資料到-csv)
